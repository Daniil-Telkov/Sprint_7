...
public class CourierCreateTests {
    ...
    public void createExistingCourierTest() {
        ...
        String actualMessage = sendPostRequest(COURIER_CREATE_API, createCourier)
                .then()
                .assertThat()
    ...
    public void createCourierEmptyPasswordTest() {
        ...
        String actualMessage = sendPostRequest(COURIER_CREATE_API, createCourierEmptyPassword)
                .then()
                .assertThat()

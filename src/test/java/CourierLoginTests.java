...
import static ru.yandex.practicum.scooter.api.config.APIConfig.*;
...
public class CourierLoginTests {
    ...
    LoginCourierRequest loginCourier = new LoginCourierRequest(DEFAULT_COURIER_LOGIN, DEFAULT_COURIER_PASSWORD);
    int createdCourierID;
    @Before
    public void setUp() {
        RestAssured.baseURI = BASE_URL;
        // Создание курьера для тестов на авторизацию
        Boolean createResult = sendPostRequest(COURIER_CREATE_API, createCourier)
                .then()
                .assertThat()
        ...
        LoginCourierRequest createdCourier = new LoginCourierRequest(DEFAULT_COURIER_LOGIN, DEFAULT_COURIER_PASSWORD);
    ...
    public void courierLoginEmptyPasswordTest() {
        LoginCourierRequest loginCourierEmptyPassword = new LoginCourierRequest(DEFAULT_COURIER_LOGIN, "");
    ...
    public void courierLoginNotExistingLoginTest() {
        LoginCourierRequest loginNotExistingLogin = new LoginCourierRequest(NOT_EXISTING_COURIER_LOGIN, DEFAULT_COURIER_PASSWORD);
